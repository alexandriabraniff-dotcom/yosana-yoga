export default function Footer() {
  ...
  return (
    <footer className="bg-[#F7F5F1] border-t border-[#E0DDD8] py-12 px-8 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-8 border-t border-[#E0DDD8] text-[10px] text-[#B0B8B8] flex flex-col md:flex-row justify-between gap-2 uppercase tracking-widest">
